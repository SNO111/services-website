    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link" href="{{ route('pheader.index') }}"
                        aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                            class="hide-menu">Bammer
                        </span></a>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('feature.index') }}"
                        aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
                            class="hide-menu">Features</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('service.index') }}"
                        aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                            class="hide-menu">Services</span></a></li>

                <li class="list-divider"></li>
                <li class="nav-small-cap"><span class="hide-menu">Site Pages</span></li>
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('about.index') }}"
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="../../docs/docs.html"
                    ...
                    <!--
                    </i><spanclass="hide-menu">Logout</span></a></li>
                    -->
            </ul>
        </nav>
