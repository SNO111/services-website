...
<section>
    <div class="bg-gradient-primary position-relative">
      <img src="{{ asset('front/img/shapes/waves-white.svg') }}" alt="pattern-lines" class="position-absolute start-0 top-md-0 w-100 opacity-6">
      <div class="container pb-lg-9 pb-7 pt-9 postion-relative z-index-2">
        <div class="row">
