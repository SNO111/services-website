...
@endpush
@section('content')
        <div class="page-header min-vh-75" style="background-image: url({{ asset('front/img/office-dark.jpg') }}); background-position-y: 50%;">
          <span class="mask bg-gradient-dark opacity-8"></span>
          <div class="container py-9">
            <div class="row justify-content-center">
              <div class="col-lg-8 text-center mx-auto my-auto">
                <h1 class="text-white">Work with an amazing <span class="text-white" id="typed">tool</span></h1>
                ...
                <button type="submit" class="btn bg-white  bg-gradient-primary">Download Company Profile</button>
                <h6 class="text-white mb-2 mt-5">Find us on</h6>
                <div class="d-flex justify-content-center">
                  <a href="javascript:;"><i class="fab fa-facebook text-lg text-white me-4" aria-hidden="true"></i></a>
                  <a href="javascript:;"><i class="fab fa-twitter text-lg text-primary me-4" aria-hidden="true"></i></a>
                  <a href="javascript:;"><i class="fab fa-instagram text-lg text-white me-4" aria-hidden="true"></i></a>
                  <a href="javascript:;"><i class="fab fa-github text-lg text-white" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="row justify-content-start">
            ...
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>{{ $aboutb->title_1 }}</h5>
                <p>{{ $aboutb->short_text_1 }}</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>{{ $aboutb->title_2 }}</h5>
                <p>{{ $aboutb->short_text_2 }}</p>
              </div>
            </div>
          </div>
          <div class="row justify-content-start">
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>{{ $aboutb->title_3 }}</h5>
                <p>{{ $aboutb->short_text_3 }}</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>{{ $aboutb->title_4 }}</h5>
                <p>{{ $aboutb->short_text_4 }}</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 ms-auto mt-lg-0 mt-4">
          <div class="card shadow-lg">
            ...
            <div class="card-body">
              <a href="javascript:;">
                <h5 class="mt-3">
                  Get insights About Our Story
                </h5>
              </a>
              <p>{{ $aboutb->story_description }}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="pt-sm-0 pb-5 position-relative bg-gradient-grey">
    <div class="container">
      <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('front/img/kal-visuals-square.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
          ...
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('front/img/bruce-mars.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
          ...
          <div class="card card-profile overflow-hidden z-index-2">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('front/img/team-4.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
          ...
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden z-index-2">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('front/img/ivana-square.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
    ...
    <div class="container">
      <div class="row mb-7">
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('front/img/logos/gray-logos/logo-coinbase.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('front/img/logos/gray-logos/logo-nasa.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('front/img/logos/gray-logos/logo-netflix.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('front/img/logos/gray-logos/logo-pinterest.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('front/img/logos/gray-logos/logo-spotify.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('front/img/logos/gray-logos/logo-vodafone.svg') }}" alt="logo">
        </div>
      </div>
      <div class="row justify-content-center text-center">
        @forelse ( $stats as $stats)
        <div class="col-md-3">
          <h1 class="text-gradient text-info" id="state1" countto="{{ $stats->projects }}">{{ $stats->projects }}</h1>
          <h5>Projects</h5>
          <p>{{ $stats->projects_desc }}</p>
        </div>
        <div class="col-md-3">
          <h1 class="text-gradient text-info"><span id="state2" countto="{{ $stats->hours }}">{{ $stats->hours }}</span>+</h1>
          <h5>Hours</h5>
          <p>{{ $stats->hours_desc }}</p>
        </div>
        <div class="col-md-3">
          <h1 class="text-gradient text-info"><span id="state3" countto="{{ $stats->support }}">{{ $stats->support }}</span>/7</h1>
          <h5>Support</h5>
          <p>{{ $stats->support_desc }}</p>
        </div>
        @empty        
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          <h1 class="text-gradient text-info"><span id="state3" countto="24">{{ $stats->support }}</span>/7</h1>
          <h5>Support</h5>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 m-auto">
          <h4 class="text-white">Be the first to see the news</h4>
          <p class="mb-4">
          ...
          <div class="row">
            ...
            <div class="col-4 ps-0">
              <button type="button" class="btn bg-gradient-primary mb-0 h-100 position-relative z-index-2">Subscribe</button>
            </div>
          </div>
        </div>
        <div class="col-md-5 ms-auto">
          <div class="position-relative">
            <img class="max-width-50 w-100 position-relative z-index-2" src="{{ asset('front/img/illustrations/sign-up.png') }}" alt="image">
          </div>
        </div>
      </div>
    </div>
...
@endsection
@push('scripts')
<script src="{{ asset('front/js/plugins/anime.min.js') }}" type="text/javascript"></script>
<script>
